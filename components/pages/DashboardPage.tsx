                    ...
                    <div className="h-full max-h-64 overflow-y-auto pr-1 relative custom-scrollbar">
                        {selectedCategory ? (
                            <div key={selectedCategory.id} className="animate-fade-in-scale">
                                 <div className="flex items-center gap-2 mb-4 sticky top-0 bg-white dark:bg-neutral-900 py-2 z-10">
          ...
          {financialSummary ? (
              <Card className="flex flex-col gap-6">
                  ...
                  {subscriptionStatus !== 'free' && (
                      <div className={`mt-2 p-4 rounded-xl flex gap-4 items-start border ${
                          financialSummary.navigatorInsight.type === 'success' ? 'bg-green-50 dark:bg-green-900/10 border-green-100 dark:border-green-900/30' :
                          ...
                          <div className={`p-2 rounded-lg mt-0.5 ${
                              financialSummary.navigatorInsight.type === 'success' ? 'bg-green-100 dark:bg-green-800 text-green-700 dark:text-green-200' :
                          ...
                          <div>
                              <h4 className={`text-sm font-bold mb-1 ${
                                  financialSummary.navigatorInsight.type === 'success' ? 'text-green-800 dark:text-green-200' :
                                  financialSummary.navigatorInsight.type === 'warning' ? 'text-amber-800 dark:text-amber-200' :
                                  'text-blue-800 dark:text-blue-200'
                              }`}>O Navegador</h4>
                              <p className={`text-sm leading-relaxed ${
                                  financialSummary.navigatorInsight.type === 'success' ? 'text-green-700 dark:text-green-300' :
