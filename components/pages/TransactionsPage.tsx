    ...
    const listComponent = (
        <Card>
                        ...
                        {(['todos', 'despesa', 'rendimento', 'transferencia'] as const).map(type => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex-1 group flex items-center justify-center gap-1.5 py-2 px-2 sm:px-3 rounded-lg text-xs sm:text-sm font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500 dark:focus-visible:ring-offset-black ${
                                        filterTipo === type
            ...
            <TransactionList 
                ...
                onEdit={(tx) => dispatch({type: 'START_EDIT', payload: tx})}
